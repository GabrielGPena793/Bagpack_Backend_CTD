...
INSERT INTO categories (name) VALUES ('Tablets e Celulares');
INSERT INTO categories (name) VALUES ('TV');
INSERT INTO categories (name) VALUES ('Promoção de Páscoa');
INSERT INTO products (title, description, price, image) VALUES
('Computador Completo Fácil Intel 4GB SSD 120GB Monitor 19\" HDMI LED Teclado e Mouse.',
'Nossos computadores são equipados com os mais recentes processadores de alta velocidade, maximizando sua produção.',
1729.50, 'Caminho da imagem');

INSERT INTO products (title, description, price, image) VALUES
('Intel Core i5 8GB SSD 240GB Monitor 19\" HDMI LED Teclado e Mouse.',
'Execute suas atividades de forma eficaz e com alto desempenho e baixo consumo de energia.',
2066.10, 'Caminho da imagem');
...
1423.90, 'Caminho da imagem');

INSERT INTO products (title, description, price, image) VALUES
('Computador Desktop Intel Core i5 Com Bluetooth 8GB HD 500GB Hdmi Windows 10 Teclado Mouse Pc Wifi.',
...
2250.70, 'Caminho da imagem');

INSERT INTO products (title, description, price, image) VALUES
('Notebook Dell Inspiron I15-3501-A10P Intel Pentium Gold-7505 4GB 128GB W10 HD 15.6\" Preto.',
'Processador Intel Pentium Gold: ideal para as tarefas do dia a dia. Memória e armazenamento pensados para o dia a dia.',
2612.50, 'Caminho da imagem');
INSERT INTO products (title, description, price, image) VALUES
...
1863.55, 'Caminho da imagem');

INSERT INTO products (title, description, price, image) VALUES
('Tablet Samsung Galaxy A T295 32GB 4G Tela 8\" Android Quad-Core 2GHz, 2GB RAM, Câmera 8MP AF + 2MP - Preto.',
'Descubra um companheiro prático no Galaxy Tab A (8.0”), um tablet que se destaca do básico e acrescenta algo a mais.',
1029.60, 'Caminho da imagem');

INSERT INTO products (title, description, price, image) VALUES
('Smartphone Motorola Moto E7 Dual Chip Android 10 Tela 6.5” 64GB Câmera 48MP + 2MP Frontal 5MP – Cinza Metálico.',
...
2410.60, 'Caminho da imagem');
INSERT INTO products (title, description, price, image) VALUES
('Smart TV LG OLED 55\" 4K OLED55A1 Dolby Vision IQ Dolby Atmos Inteligência Artificial Thinqai Google Alexa.',
